...
tester_params = {
    ...
    'model_load': {
        'path': '/home/pjy/mycode/MOVRPDACT/construct_model/TSP/construct_model_TSP/100_reasonable',  # directory path of pre-trained model and log files saved.
...
def construct_routes_TSP100(shared_problem, pref, begin_epoch = 10):
    
    tester_params['model_load']['epoch'] = begin_epoch
