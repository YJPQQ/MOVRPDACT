...
tester_params = {
    ...
    'model_load': {
        'path': '/home/pjy/OPEN_SOURCE_CODE/VRP-DACT/construct_model/TSP/construct_model_TSP/20',  # directory path of pre-trained model and log files saved.
...
def construct_routes_TSP20(shared_problem, pref, begin_epoch = 10):
