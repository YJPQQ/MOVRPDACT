...
from construct_model.TSP.TSProblemDef import get_random_problems, augment_xy_data_by_8_fold
...
class TSPEnv:
    ...
    def load_problems(self, batch_size, aug_factor=1):
        ...
        self.weight = weight 
        weight = weight.expand(batch_size,self.problem_size,2)

        self.concat_problems = torch.cat((self.problems,weight),dim = 2)
    ...
    def reset(self):
        ...
        return Reset_State(self.concat_problems), reward, done
