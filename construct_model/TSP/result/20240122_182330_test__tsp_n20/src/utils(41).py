...
def validate_with_construct(rank, problem, agent, val_dataset, tb_logger, distributed = False, _id = None):
    ...
    for batch_id, batch in enumerate(val_dataloader):
        ...
        for st in range(prefs.shape[0]):
            ...
            bv, cost_hist, best_hist, r, rec_history = agent.rollout_with_construct(problem,
                                                                    opts.val_m,
                                                                    batch,
                                                                    pref,
                                                                    do_sample = True,
