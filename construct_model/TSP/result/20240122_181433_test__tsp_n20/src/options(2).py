...
def get_options(args=None):
    ...
    parser.add_argument('--epoch_size', type=int, default=512*1, help='number of instances per epoch during training')
    ...
    parser.add_argument('--with_construct_before', action='store_true',default=True, help='switch to inference mode')
    ...
    parser.add_argument('--val_dataset', type=str, default = './data/testdata_tsp_size20.pt', help='dataset file path')
